...
public class ControllerTestData {
    ...
    public static final Map<String, Object> EXPECTED_RESPONSE_HEADERS = new HashMap<>() {{
        ...
        put("Content-Security-Policy", "connect-src 'self'; default-src 'none'; font-src 'self'; img-src 'self' data:; script-src 'self'; style-src 'self' 'unsafe-inline'; base-uri 'none'; frame-ancestors 'none'; block-all-mixed-content");
        put("Pragma", "no-cache");
