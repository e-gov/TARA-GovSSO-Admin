...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.tARAGOVSSOAdmin.base-path:/edurdo/admin/1.0.0}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("ee.ria.tara.api"))
                    .build()
