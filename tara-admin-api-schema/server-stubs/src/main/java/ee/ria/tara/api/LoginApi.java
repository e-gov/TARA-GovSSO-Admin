...
public interface LoginApi {
    ...
    @Operation(
        ...
        tags = { "user" },
        responses = {
            @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  LoginResponse.class))),
    ...
    default ResponseEntity<LoginResponse> loginUser(
        @Parameter(name = "LoginRequest", description = "Authentication request object", required = true, schema = @Schema(description = "")) @Valid @RequestBody LoginRequest loginRequest
    ) {
