...
public interface AlertsApi {
    ...
    @Operation(
        ...
        tags = { "alerts" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  Alert.class))),
    ...
    default ResponseEntity<Alert> addAlert(
        @Parameter(name = "Alert", description = "Client object that needs to be added", required = true, schema = @Schema(description = "")) @Valid @RequestBody Alert alert
    ) {
    ...
    default ResponseEntity<Void> deleteAlert(
        @Parameter(name = "alert_id", description = "Alert ID", required = true, schema = @Schema(description = "")) @PathVariable("alert_id") String alertId
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
