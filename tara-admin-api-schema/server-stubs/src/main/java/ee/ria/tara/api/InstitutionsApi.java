...
@Validated
@Tag(name = "institutions", description = "the institutions API")
public interface InstitutionsApi {
    ...
    default ResponseEntity<Void> addClientToInstitution(
        @Parameter(name = "registry_code", description = "Registry code of the institution", required = true, schema = @Schema(description = "")) @PathVariable("registry_code") String registryCode,
        @Parameter(name = "Client", description = "Client object that needs to be added", required = true, schema = @Schema(description = "")) @Valid @RequestBody Client client
    ) {
    ...
    default ResponseEntity<Void> addInstitution(
        @Parameter(name = "Institution", description = "Institution object that needs to be added", required = true, schema = @Schema(description = "")) @Valid @RequestBody Institution institution
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> deleteClient(
        @Parameter(name = "registry_code", description = "Registry code of the institution", required = true, schema = @Schema(description = "")) @PathVariable("registry_code") String registryCode,
        @Parameter(name = "client_id", description = "OpenID Connect client_id", required = true, schema = @Schema(description = "")) @PathVariable("client_id") String clientId
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<List<Institution>> getAllInstitutions(
        @Parameter(name = "filter_by", description = "Filters search results by name or registry code", schema = @Schema(description = "")) @Valid @RequestParam(value = "filter_by", required = false) String filterBy
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"address\" : \"Test st 123\", \"billing_settings\" : { \"email\" : \"email\" }, \"updated_at\" : \"2019-08-24T14:15:22Z\", \"phone\" : \"+3726630200\", \"name\" : \"Example Institution\", \"created_at\" : \"2019-08-24T14:15:22Z\", \"id\" : \"id\", \"type\" : { \"type\" : \"public\" }, \"registry_code\" : \"12345678\", \"client_ids\" : [ \"openIdDemo\", \"openIdDemo\" ], \"email\" : \"info@example.com\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    @Operation(
        ...
        tags = { "institutions" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  InstitutionMetainfo.class))),
            @ApiResponse(responseCode = "400", description = "Invalid input")
        },
        security = {
            @SecurityRequirement(name = "cookieAuth")
    ...
    default ResponseEntity<List<InstitutionMetainfo>> getInstitutionMetainfo(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"name\" : \"Example Institution\", \"type\" : { \"type\" : \"public\" }, \"registry_code\" : \"12345678\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    default ResponseEntity<Void> updateInstitution(
        @Parameter(name = "registry_code", description = "Registry code of the institution", required = true, schema = @Schema(description = "")) @PathVariable("registry_code") String registryCode,
        @Parameter(name = "Institution", description = "Institution object that needs to be updated", required = true, schema = @Schema(description = "")) @Valid @RequestBody Institution institution
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
