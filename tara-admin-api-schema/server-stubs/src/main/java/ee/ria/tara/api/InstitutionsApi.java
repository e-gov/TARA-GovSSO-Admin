...
public interface InstitutionsApi {
    ...
    public static final String PATH_ADD_CLIENT_TO_INSTITUTION = "/institutions/{registry_code}/clients";
    /**
    ...
    @RequestMapping(
        ...
        value = InstitutionsApi.PATH_ADD_CLIENT_TO_INSTITUTION,
    ...
    public static final String PATH_ADD_INSTITUTION = "/institutions";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = InstitutionsApi.PATH_ADD_INSTITUTION,
        consumes = { "application/json" }
    )
    ...
    public static final String PATH_DELETE_CLIENT = "/institutions/{registry_code}/clients/{client_id}";
    /**
    ...
    @RequestMapping(
        ...
        value = InstitutionsApi.PATH_DELETE_CLIENT
    )
    ...
    public static final String PATH_DELETE_INSTITUTION = "/institutions/{registry_code}";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.DELETE,
        value = InstitutionsApi.PATH_DELETE_INSTITUTION
    )
    ...
    public static final String PATH_GET_ALL_INSTITUTION_CLIENTS = "/institutions/{registry_code}/clients";
    /**
    ...
    @RequestMapping(
        ...
        value = InstitutionsApi.PATH_GET_ALL_INSTITUTION_CLIENTS,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"access_token_audience_uris\" : [ \"https://jwt-service-uri.test.ee\", \"https://jwt-service-uri.test.ee\" ], \"session_lifespan\" : \"89d1h\", \"client_url\" : \"https://client.example.com/\", \"minimum_acr_value\" : \"high\", \"skip_user_consent_client_ids\" : [ \"openIdDemo\", \"openIdDemo\" ], \"description\" : \"description\", \"created_at\" : \"2019-08-24T14:15:22Z\", \"client_type\" : \"DEFAULT\", \"client_id\" : \"openIdDemo\", \"token_endpoint_auth_method\" : \"client_secret_basic\", \"paasuke_parameters\" : \"ns=A&role=B\", \"client_secret_export_settings\" : { \"recipient_id_code\" : \"60001019906\", \"recipient_email\" : \"60001019906@eesti.ee\" }, \"updated_at\" : \"2019-08-24T14:15:22Z\", \"client_short_name\" : { \"ru\" : \"ru\", \"en\" : \"en\", \"et\" : \"et\" }, \"scope\" : [ \"scope\", \"scope\" ], \"token_request_allowed_ip_addresses\" : [ \"token_request_allowed_ip_addresses\", \"token_request_allowed_ip_addresses\" ], \"client_contacts\" : [ { \"phone\" : \"+3726630200\", \"name\" : \"test\", \"department\" : \"test\", \"email\" : \"test@example.com\" }, { \"phone\" : \"+3726630200\", \"name\" : \"test\", \"department\" : \"test\", \"email\" : \"test@example.com\" } ], \"id\" : \"id\", \"backchannel_logout_uri\" : \"https://example.com/\", \"client_name\" : { \"ru\" : \"ru\", \"en\" : \"en\", \"et\" : \"et\" }, \"post_logout_redirect_uris\" : [ \"https://logout-redirect-uri.test.ee/callback\", \"https://logout-redirect-uri.test.ee/callback\" ], \"institution_metainfo\" : { \"name\" : \"Example Institution\", \"type\" : { \"type\" : \"public\" }, \"registry_code\" : \"12345678\" }, \"allow_secured_app_web_session\" : false, \"smartid_settings\" : { \"should_use_additional_verification_code_check\" : true, \"relying_party_name\" : \"relying_party_name\", \"relying_party_UUID\" : \"relying_party_UUID\" }, \"sla_notification_emails\" : [ \"katkestused@test.ee\", \"katkestused@test.ee\" ], \"redirect_uris\" : [ \"https://redirect-uri.test.ee/callback\", \"https://redirect-uri.test.ee/callback\" ], \"secured_app_session_max_duration\" : \"12h\", \"is_user_consent_required\" : false, \"eidas_requester_id\" : \"urn:uuid:33ca0ae1-a5fb-4885-80d7-6af6bf6e0e5f\", \"mid_settings\" : { \"relying_party_name\" : \"relying_party_name\", \"relying_party_UUID\" : \"relying_party_UUID\" }, \"access_token_lifespan\" : \"15m\", \"access_token_jwt_enabled\" : false, \"client_logo\" : \"client_logo\", \"info_notification_emails\" : [ \"teavitused@test.ee\", \"teavitused@test.ee\" ] }, { \"access_token_audience_uris\" : [ \"https://jwt-service-uri.test.ee\", \"https://jwt-service-uri.test.ee\" ], \"session_lifespan\" : \"89d1h\", \"client_url\" : \"https://client.example.com/\", \"minimum_acr_value\" : \"high\", \"skip_user_consent_client_ids\" : [ \"openIdDemo\", \"openIdDemo\" ], \"description\" : \"description\", \"created_at\" : \"2019-08-24T14:15:22Z\", \"client_type\" : \"DEFAULT\", \"client_id\" : \"openIdDemo\", \"token_endpoint_auth_method\" : \"client_secret_basic\", \"paasuke_parameters\" : \"ns=A&role=B\", \"client_secret_export_settings\" : { \"recipient_id_code\" : \"60001019906\", \"recipient_email\" : \"60001019906@eesti.ee\" }, \"updated_at\" : \"2019-08-24T14:15:22Z\", \"client_short_name\" : { \"ru\" : \"ru\", \"en\" : \"en\", \"et\" : \"et\" }, \"scope\" : [ \"scope\", \"scope\" ], \"token_request_allowed_ip_addresses\" : [ \"token_request_allowed_ip_addresses\", \"token_request_allowed_ip_addresses\" ], \"client_contacts\" : [ { \"phone\" : \"+3726630200\", \"name\" : \"test\", \"department\" : \"test\", \"email\" : \"test@example.com\" }, { \"phone\" : \"+3726630200\", \"name\" : \"test\", \"department\" : \"test\", \"email\" : \"test@example.com\" } ], \"id\" : \"id\", \"backchannel_logout_uri\" : \"https://example.com/\", \"client_name\" : { \"ru\" : \"ru\", \"en\" : \"en\", \"et\" : \"et\" }, \"post_logout_redirect_uris\" : [ \"https://logout-redirect-uri.test.ee/callback\", \"https://logout-redirect-uri.test.ee/callback\" ], \"institution_metainfo\" : { \"name\" : \"Example Institution\", \"type\" : { \"type\" : \"public\" }, \"registry_code\" : \"12345678\" }, \"allow_secured_app_web_session\" : false, \"smartid_settings\" : { \"should_use_additional_verification_code_check\" : true, \"relying_party_name\" : \"relying_party_name\", \"relying_party_UUID\" : \"relying_party_UUID\" }, \"sla_notification_emails\" : [ \"katkestused@test.ee\", \"katkestused@test.ee\" ], \"redirect_uris\" : [ \"https://redirect-uri.test.ee/callback\", \"https://redirect-uri.test.ee/callback\" ], \"secured_app_session_max_duration\" : \"12h\", \"is_user_consent_required\" : false, \"eidas_requester_id\" : \"urn:uuid:33ca0ae1-a5fb-4885-80d7-6af6bf6e0e5f\", \"mid_settings\" : { \"relying_party_name\" : \"relying_party_name\", \"relying_party_UUID\" : \"relying_party_UUID\" }, \"access_token_lifespan\" : \"15m\", \"access_token_jwt_enabled\" : false, \"client_logo\" : \"client_logo\", \"info_notification_emails\" : [ \"teavitused@test.ee\", \"teavitused@test.ee\" ] } ]";
    ...
    public static final String PATH_GET_ALL_INSTITUTIONS = "/institutions";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = InstitutionsApi.PATH_GET_ALL_INSTITUTIONS,
        produces = { "application/json" }
    )
    
    default ResponseEntity<List<Institution>> getAllInstitutions(
        @Parameter(name = "filter_by", description = "Filters search results by name or registry code", in = ParameterIn.QUERY) @Valid @RequestParam(value = "filter_by", required = false) @Nullable String filterBy
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    public static final String PATH_GET_INSTITUTION_METAINFO = "/institutions/metainfo";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = InstitutionsApi.PATH_GET_INSTITUTION_METAINFO,
        produces = { "application/json" }
    )
    ...
    public static final String PATH_UPDATE_CLIENT = "/institutions/{registry_code}/clients/{client_id}";
    /**
    ...
    @RequestMapping(
        ...
        value = InstitutionsApi.PATH_UPDATE_CLIENT,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    ...
    public static final String PATH_UPDATE_INSTITUTION = "/institutions/{registry_code}";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.PUT,
        value = InstitutionsApi.PATH_UPDATE_INSTITUTION,
        consumes = { "application/json" }
    )
