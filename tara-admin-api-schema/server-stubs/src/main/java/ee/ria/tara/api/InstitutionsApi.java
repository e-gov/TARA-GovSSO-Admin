...
@Validated
@Tag(name = "institutions", description = "OpenID Connect client details")
public interface InstitutionsApi {
    ...
    default ResponseEntity<Void> addClientToInstitution(
        @Parameter(name = "registry_code", description = "Registry code of the institution", required = true) @PathVariable("registry_code") String registryCode,
    ...
    default ResponseEntity<Void> deleteClient(
        @Parameter(name = "registry_code", description = "Registry code of the institution", required = true) @PathVariable("registry_code") String registryCode,
        @Parameter(name = "client_id", description = "OpenID Connect client_id", required = true) @PathVariable("client_id") String clientId
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<List<Institution>> getAllInstitutions(
        @Parameter(name = "filter_by", description = "Filters search results by name or registry code") @Valid @RequestParam(value = "filter_by", required = false) String filterBy
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful operation", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = InstitutionMetainfo.class))
            }),
            @ApiResponse(responseCode = "400", description = "Invalid input")
        },
        security = {
